...
import { WebAppContainer } from './src/presentation/components/web-app-container/web-app-container-component';
...
export default function App() {
  const [selectedGoalId, setSelectedGoalId] = useState<string | null>(null);
    ...
    //   sendToWeb(webViewRef, 'NATIVE_PING', {
    //     message: `Ping desde React Native CLI con TS (${new Date().toLocaleTimeString()})`,
    //   });
    // };
